...
class ReadmeGenerator:
    ...
    def __tablo_olustur(self, kartlar:bool=False):
        ...
        for repo in self.repolar:
            if repo['name'].lower().startswith("0x733"):
                continue
...
<details align="center">
    <summary style="font-weight: bold; font-size: 18px">
        ...
        if self.rozet:
            dosya.append(f"\n\n[![Otomatik Profil Güncelleyici](https://github.com/{self.kullanici_adi}/{self.kullanici_adi}/actions/workflows/0x733.yml/badge.svg)](https://github.com/{self.kullanici_adi}/{self.kullanici_adi}/actions/workflows/0x733.yml)\n")
